...
?>
				<img class="gravatar" src="//cn.gravatar.com/avatar/00000000000000000000000000000000?d=mm&s=40"><?php comment_form_title('<span class="hidden">忍不住就</span>吐个槽吧', '有话对 %s 说？'); ?><small class="cancelCommentReply"><?php cancel_comment_reply_link('（取消）'); ?></small>
			</h5>
